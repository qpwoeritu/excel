...
NextCell:
    ...
    ' čas zápisu do SLD si meria runCALC (zapíąe do index!J8) – tu uľ nezapisujeme do B5.
...
Private Sub LoadResultsToDict(ByRef dN As Object, ByRef dL As Object, ByRef dT As Object, ByRef dR As Object, ByRef dDR As Object, ByRef dC As Object, ByRef dM As Object, ByRef dG As Object, ByRef dQ As Object)
    ...
    ' Tolerantné hľadanie – názov hárku má diakritiku a pri zlom kódovaní
    ' importovaného modulu by priamy prístup skončil chybou 9 (subscript).
    Set ws = FindSheetTolerant("kompenzácia")
    If ws Is Nothing Then
        Err.Raise vbObjectError + 35, "LoadResultsToDict", "Hárok 'kompenzácia' sa nenašiel."
    End If
    lastRow = ws.Cells(ws.Rows.Count, 2).End(xlUp).Row
    For i = 3 To lastRow
        name = CStr(ws.Cells(i, 2).Value)
