'==========================
' Modul: modComplex
' Posledná úprava: A1–A4 quick wins (perf)
'==========================
Option Explicit
...
' Vytvorenie z polárneho tvaru, kde uhol je už v RADIÁNOCH.
' Rýchlejšia varianta k CFromPolar – v load-flow cykloch sú uhly natívne
' v radiánoch a nemá zmysel ich konvertovať na stupne a späť.
