    ...
    For k = 1 To nBranches
        ...
        Else
            ...
            If Abs(Zpu.Re) < 0.000000001 And Abs(Zpu.Im) < 0.000000001 Then
                ...
                Ploss_pu = 0#
            Else
                ' pr˙d vetvou v p.u.: I_ij = (Vi - Vj) / Z_ij + Vi * j*B/2 (PI Ël·nok)
...
Public Sub LoadBranchData( _
    ...
    For i = 1 To nBranches
        ...
        ' naËÌtanie skutoËnej impedancie - R z N(14), X z O(15), B z P(16)
...
' NaËÌtanie d·t o spÌnaËoch z h·rka "spinace"
...
' Z·pis v˝sledn˝ch pr˙dov spÌnaËov do h·rka "spinace"
